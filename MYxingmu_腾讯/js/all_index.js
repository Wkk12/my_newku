                ...
                <div class="list_one">
                    <div class="kuang">
                        <div class="list_one_kuang">
                            <img class="tupian_tiaozhuan" src="`+one_data.img+`" alt=""> 
                    ...
                    <div class="kuang">
                        <div class="list_one_kuang">
                            <img class="tupian_tiaozhuan" src="`+one_data.img_T+`" alt="">
...
for(var i = 0; i<shujuer.length;i++){
    ...
    content_str_er +=`
                <div class="list_one">
                    <div class="kuang">
                    <div class="list_one_kuang">
                    <img class="tupian_tiaozhuan" src="`+two_data.img+`" alt=""> 
                    ...
                    <div class="kuang">
                    <div class="list_one_kuang">
                        <img class="tupian_tiaozhuan" src="`+two_data.img_T+`" alt="">
    ...
    content_str_san +=`
                <div class="San" >
                        <div class="xiao_kuang">
                            <div class="SAN_tishi">
                                <img class="tupian_tiaozhuan" src="`+san_data.img+`" alt=""> </br>
